...
<head>
    <meta charset="UTF-8">
    <title>سند صرف - {{ $journalEntry->entry_number }}</title>
    <style>
        body {
...
<body onload="window.print()">
    ...
    <div class="container">
        ...
        <table class="details-table">
            ...
            @endif
            <tr>
                <td class="label">صرف للحساب (المدين)</td>
                <td>
                    @php
                        // الحساب المدين (المستلم) هو السطر الأول في سندات الصرف
            ...
            <tr>
                <td class="label">صرف من الحساب (الدائن)</td>
                <td>
                    @php
                        // الحساب الدائن (الخزينة/البنك) هو السطر الثاني
