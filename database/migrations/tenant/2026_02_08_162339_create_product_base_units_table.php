...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('product_base_units', function (Blueprint $table) {
            ...
            $table->index(['product_id', 'is_active'], 'idx_pbu_product_active');
            $table->index(['base_unit_type', 'is_active'], 'idx_pbu_unit_type_active');
            $table->index(['base_unit_code'], 'idx_pbu_unit_code');
            $table->index(['effective_from', 'effective_to'], 'idx_pbu_effective_dates');
            $table->index(['is_active', 'effective_from'], 'idx_pbu_active_from');
            $table->index('created_at', 'idx_pbu_created_at');
