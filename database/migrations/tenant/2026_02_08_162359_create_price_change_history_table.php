...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('price_change_history', function (Blueprint $table) {
            ...
            $table->index(['product_id', 'changed_at'], 'idx_pch_product_changed');
            $table->index(['base_unit_id', 'changed_at'], 'idx_pch_base_changed');
            $table->index(['changed_by', 'changed_at'], 'idx_pch_user_changed');
            $table->index(['changed_at'], 'idx_pch_changed_at');
            $table->index(['selling_units_updated'], 'idx_pch_units_updated');
