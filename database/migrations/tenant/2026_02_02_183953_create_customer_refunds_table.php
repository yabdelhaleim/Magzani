...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('customer_refunds', function (Blueprint $table) {
            ...
            $table->index('customer_id', 'idx_cust_refunds_customer_id');
            $table->index('invoice_id', 'idx_cust_refunds_invoice_id');
            $table->index('status', 'idx_cust_refunds_status');
            $table->index('created_at', 'idx_cust_refunds_created_at');
