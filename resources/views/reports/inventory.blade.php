...
<div class="space-y-4 md:space-y-6">
    ...
    <!-- Header -->
    <div class="bg-gradient-to-r from-blue-600 via-cyan-600 to-teal-600 rounded-2xl p-4 md:p-8 text-white shadow-2xl relative overflow-hidden">
        <div class="absolute top-0 left-0 w-full h-full opacity-10">
            <div class="absolute top-10 right-10 w-20 md:w-32 h-20 md:h-32 bg-white rounded-full blur-3xl"></div>
            <div class="absolute bottom-10 left-10 w-24 md:w-40 h-24 md:h-40 bg-white rounded-full blur-3xl"></div>
        </div>
        <div class="relative z-10">
            <h2 class="text-2xl md:text-4xl font-bold mb-2">تقرير المخزون الشامل</h2>
            <p class="text-white/80 text-sm md:text-lg">عرض تفصيلي لجميع الأصناف والكميات المتاحة</p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-4 md:p-6">
        <h3 class="text-lg md:text-xl font-bold text-gray-800 mb-4 flex items-center gap-2">
            ...
            <span class="hidden sm:inline">تصفية التقرير</span>
            <span class="sm:hidden">تصفية</span>
        </h3>
        <form method="GET" action="{{ route('reports.inventory') }}" class="grid grid-cols-1 md:grid-cols-12 gap-3 md:gap-4">
            ...
            <div class="md:col-span-4">
                ...
                <select name="warehouse_id" class="w-full px-3 md:px-4 py-2 md:py-2.5 bg-gray-50 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition">
            ...
            <div class="md:col-span-3">
                ...
                <input type="text" 
                       ...
                       class="w-full px-3 md:px-4 py-2 md:py-2.5 bg-gray-50 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition">
            </div>
