...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('product_selling_units', function (Blueprint $table) {
            ...
            // ===== INDEXES =====
            $table->index(['product_id', 'is_active'], 'idx_psu_product_active');
            $table->index(['product_id', 'is_default'], 'idx_psu_product_default');
            $table->index(['product_id', 'is_base'], 'idx_psu_product_base');
            $table->index(['base_unit_id', 'is_active'], 'idx_psu_base_active');
            $table->index(['unit_code', 'product_id'], 'idx_psu_unit_product');
