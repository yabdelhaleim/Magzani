...
<div class="max-w-2xl mx-auto">
    ...
    <div class="glass-card rounded-2xl p-8 shadow-xl space-y-6">
        <div class="flex justify-between items-center border-b border-slate-800 pb-4">
            <h3 class="text-lg font-bold text-white">إعدادات حساب الشركة الجديد</h3>
            <a href="{{ route('super-admin.tenants.index') }}" class="text-sm text-slate-400 hover:text-white transition">إلغاء والعودة</a>
        </div>
